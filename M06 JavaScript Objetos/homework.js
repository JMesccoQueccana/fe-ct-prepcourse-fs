...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var ObjetoUsuario={nombre:nombre, email:email, password:password}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var multiplicarNumeroMisterioso=objetoMisterioso.numeroMisterioso *5;
   return multiplicarNumeroMisterioso;
}
